...
const discord_token = "Mzk5NTk2Njc0NDQ5ODAxMjE2.DZ7Z_w.sRUGQSm77FNgsEr0D-Vtgf0zq1U";
...
if(!message.channel.guild) return;
	...
	const x5bz0 = [   '*** احمد عدنان ***',   '***علي  ***',   '*** صوفي ***',   '*** سجاد***',   '*** مسلم ***',   '*** احمد سامي ***',    '*** احمد كاظم ***',   '*** محمد***',   '*** مهيمن ***',   '*** فاضل ***' , '*** منتظر ***',   '*** حسين  ***',   '*** ولا واحد ***',   '*** مجتبى ***',   '*** اديان ***',]
client.on('message', message => {
if (message.content.startsWith('*عشوائي')) {
  var sh = new Discord.RichEmbed()
  .setColor('RANDOM')
